...
"""autogenerated by genpy from gaze_tracking/Blobs.msg. Do not edit."""
import codecs
import sys
...
import gaze_tracking.msg

class Blobs(genpy.Message):
  _md5sum = "5544317ff6fcb345e7b3bfefa4c6bf5d"
  _type = "gaze_tracking/Blobs"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """gaze_tracking/Blob_Params[] blob_list
...
"""
  __slots__ = ['blob_list']
  _slot_types = ['gaze_tracking/Blob_Params[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = gaze_tracking.msg.Blob_Params()
        _x = val1
        start = end
        end += 13
